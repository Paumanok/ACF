...
cat1 = pet(0,"sniffles", 5, 25, 10)
cat1.feed_times = {"M":[(0000,2400)], "T":[(0000, 2400)], "W":[(0000, 2400)], "R":[(0000, 2400)], "F":[], "S":[], "U":[(0000,2400)]}
cat1 = cat1.__dict__
cat2 = pet(0,"fluff", 2, 15, 50).__dict__
cat3 = pet(0,"mango", 4, 12, 50).__dict__
